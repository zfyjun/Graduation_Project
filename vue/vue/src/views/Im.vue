          ...
          <div style="padding: 10px 0" v-for="(user,index) in newUsers" :key="user.username" class="userBox">
            <div class="usernameBox">
              ...
              <div v-for="unRead in unReadMsgs">
                <div v-if="user.username===unRead.from_user">
                  <div class="dot" v-if="unRead.un_read>0">
                    <span class="count" >{{ unRead.un_read }}</span>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div>
              <span v-if="user.isOnline==0">离线</span>
              <span v-if="user.isOnline==1">在线</span>
            </div>
          </div>
        </el-card>
      </el-col>
...
export default {
  ...
  methods: {
    ...
    unRead(){
      request.post("/chatHistory/unRead",{
