<template>
	<view>
		<view class="box" >
			<view >
				<view style="display: flex;padding-left:  5%;padding-top: 3%;">
					...
					<u--text style=" " bold :text="'信用卡等级:'+rang"></u--text>
				</view>
		...
		<view>
			<u-button style="width: 95%;" type="success" text=" 额度提升" @click="increase"></u-button>
		</view>
		<view class="box" >
			<view >
				<u-collapse
		...
		<view>
			<u-button style="width: 95%;" type="primary" text=" 信用卡升级" @click="update"></u-button>
		</view>
